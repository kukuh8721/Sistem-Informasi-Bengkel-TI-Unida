...
<body>
      <nav class="navbar navbar-defauld">
          ...
          <ul class="nav navbar-nav about">
              ...
              <li class="active"><a href="service1.php">Support Service</a></li> 
    ...
    <div class="container">
      <div class="text-center">
            <h1 style="font-family: demo; font-size: 50px;">Service Printer</h1>
            </div>
            </div>
            <br>
            <hr>
          ...
          <div class="container">
                <div class="row">
                  <div class="col-sm-4" >
                    <img src="img/icon3.png" class="img-circle" alt="random-name"> 
                  </div>
                  <div class="col-sm-8">
                    <h2>Service Printer</h2>
                    <h4>Pelayanan Service Printer di Bengkel TI Unida baru hanya bisa melayani kerusakan yang bersifat ringan
                      karena kekurangan pengalam dalam hal hardware printer. Sehingga Teknisi Bengkel TI Unida belum bisa 
                      menangani masalah kerusakan printer yang berat. <br>
                      Untuk biaya juga relative tergantung kerusakan dari printer.
</h4>
                  </div>
                </div>
              </div>
